...
typedef struct vx_req_connector_create {
     ...
     * \note minimum_port and maximum_port should both be set to 0 or both be set to a specific port range.
     * \note Because of restricted port ranges, consoles use different values for minimum_port and maximum_port
     */
    int minimum_port;
...
typedef struct vx_req_account_anonymous_login {
     ...
     * The length of displayName is limited to a maximum of 127 bytes, plus a null terminator.
     */
    char *displayname;
...
/**
 * \deprecated Use vx_req_session_set_local_render_volume_t instead.
